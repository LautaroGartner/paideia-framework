export const post = {
  slug: "building-paideia-software-that-explains-itself",
  title: "Building Paideia: Software That Explains Itself",
  description:
    "An essay on building Paideia, why generated software should be readable, and what changes when runtime systems can describe their own shape.",
