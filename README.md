...
`v1.4.0-alpha.2` refines that foundation with path-aware manifest diagnostics so invalid contracts can be inspected, explained, and surfaced by tools.
